'''
Primeiramente, vamos criar uma representação do labirinto 
utilizando caracteres ASCII. | labirinto será representado 
por uma matriz 10x10, onde:
...
Programa em Python que utiliza a busca em profundidade (Depth-First Search, DFS) 
para encontrar o caminho da entrada até a saída do labirinto.
...
'''
Este programa primeiro define o labirinto, encontra a entrada e a saída, 
e então utiliza a busca em profundidade para encontrar um caminho da 
entrada para a saída. 
| caminho é representado por asteriscos (*) quando impresso. 
Se um caminho for encontrado, o labirinto com o caminho será exibido; 
caso contrário, uma mensagem informará que nenhum caminho foi encontrado.
'''
